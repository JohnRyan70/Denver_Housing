...
Your project seeks to address two challenges. First, it provides you with a way to visualize the many neighborhoods, based on what you consider important. Is the neighborhood fairly young? What kinds of people live there? What about the local school district? 
...
The Census Bureau's American Community Survey (ACS) collects survey data across the country, asking people a variety of questions pertaining to themselves, their households and other characteristics (e.g. age, ethnicity, household residents, income, house characteristics). In fact, the ACS offers such data further down than cities, down to census tracts! In such areas as the city of Denver proper, the ACS boundaries overlap the traditional neighborhoods quite nicely.

The ACS provides five-year average results by collecting surveys from a random sample of areas. Census tracts, as used within this project, encompass a range of 1,200 to 8,000 people.

The nice thing about the ACS survey is its ability to explore demographics. For this project, you will investigate five basic categories. First, the 'age' of the population (e.g. percentage of population as children or elderly). Second, the financial status of the population and house owners (e.g. income). Third, the types of households (e.g. married/single/widowed, income). Fourth, neighborhood housing (i.e. average age of a house, percent owned). Last, the quality of an area (i.e. state ranking of the public school district).

For each dataset you are teasing out the variables of interest and transforming them into numeric when necessary. You gather the ACS's 2010-2014 five-year estimates, the most recent data available, and also tap into the 2010 results to chart a neighborhood's growth or decline.

The data are available using the Census Bureau's American FactFinder tool [here](https://www.census.gov/acs/www/data/data-tables-and-tools/american-factfinder/).

## Using Median House Value (Not Sale Price)

You choose to use the median house value reported in the ACS results, based upon self-reports by survey respondents. While it might be ideal to use Zillow's [housing and renting data](http://www.zillow.com/research/data) - sale prices, in particular - such data do not track housing statistics in suburban areas. The data can be wonderful if you want to live in downtown Denver, but what if you want to live in Littleton or the Greenwood Village area? You know self-reported housing values are not perfect but they are available and certainly better than nothing. So, you gather the 2010-2014 estimates as well as the 2010 Census estimates.
...
### Neighborhood Ages
You collect some information pertaining to age, such as the percentage of people in certain age brackets. You wonder whether, for example, 'older' neighborhoods (i.e. high percentage of people above 65 years old) might have either 'older' houses or people less likely to purchase top-value housing.
...
Given the rising trend of non-married families, you are also curious to see whether marital status has some effect on neighborhood housing values. You consider whether neighborhoods with higher rates of married couples have higher housing values, either because of a) a greater capacity for long-term housing (i.e. potential for dual incomes, greater family stability) or b) a greater desire to settle down rather than rent an apartment. 
Is it true that neighborhoods with married couples tend to have higher-value housing?

You also add some indicators for education, from high school dropouts (no high school diploma) to people with advanced degrees. You are aware of the many reports about the relationship between education levels and income, and naturally believe this can translate to differential housing values. If it is true that people with higher education earn more, then there should be a correlation.
...
### Property Types
You are also curious to know how much of housing values might be driven by characteristics of the houses (or neighborhoods) themselves. Might neighborhoods with newer houses be 'hotter' markets than others? Might neighborhoods with many vacant properties have lower housing values? Might there be a quantitative difference between neighborhoods with many rented versus owned properties?
...
Given the economic difficulties of the Great Recession, you want to explore the impact of unemployment and underemployment. With this in mind, you include a more subtle version: the average number of hours worked.
